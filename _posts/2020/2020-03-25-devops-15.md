...
![image.png](/assets/post-img/devops/devops-15-1.png)
...
![image.png](/assets/post-img/devops/devops-15-2.png)
...
![image.png](/assets/post-img/devops/devops-15-3.png)

在服务的后台日志中也打印出来异常信息，如下图所示。从日志可以看出，该 RuntimeException 是由 Chaos Monkey 抛出的。

![image.png](/assets/post-img/devops/devops-15-4.png)
